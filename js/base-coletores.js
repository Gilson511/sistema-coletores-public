...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function carregarColetores() {
    ...
    fetch('https://sistema-coletores-backend-4.onrender.com/api/basecoletores')
  ...
  async function excluirColetor(id) {
    ...
    try {
      ...
      const baseRes = await fetch('https://sistema-coletores-backend-4.onrender.com/api/basecoletores')
;
      ...
      const coletoresRes = await fetch('https://sistema-coletores-backend-4.onrender.com/api/coletores');
      ...
      const res = await fetch(`https://sistema-coletores-backend-4.onrender.com/api/basecoletores/${id}`, {
        method: 'DELETE',
        headers: {
